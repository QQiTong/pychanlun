            ...
            >
              <el-table-column align="left" width="80">
                ...
                <template slot-scope="scope">
                  ...
                  >{{scope.row.order_book_id}}</el-link>
                </template>
              </el-table-column>
                ...
                <template slot-scope="scope">
                  <el-tag
                    ...
                    :type="levelDirectionList&&levelDirectionList[scope.row.order_book_id]?
                            ...
                            :'info'"
                  >{{ levelDirectionList&&levelDirectionList[scope.row.order_book_id]?levelDirectionList[scope.row.order_book_id]['3m']:'' }}</el-tag>
                </template>
              </el-table-column>
              <el-table-column label="3m">
                <template slot-scope="scope">
                  ...
                  >{{ beichiList[scope.row.order_book_id]['3m'] }}</el-tag>
                </template>
              </el-table-column>
                ...
                <template slot-scope="scope">
                  <el-tag
                    ...
                    :type="levelDirectionList&&levelDirectionList[scope.row.order_book_id]?
                            ...
                            :'info'"
                  >{{ levelDirectionList&&levelDirectionList[scope.row.order_book_id]?levelDirectionList[scope.row.order_book_id]['5m']:'' }}</el-tag>
                </template>
              </el-table-column>
              <el-table-column label="5m">
                <template slot-scope="scope">
                  ...
                  >{{ beichiList[scope.row.order_book_id]['5m'] }}</el-tag>
                </template>
              </el-table-column>
                ...
                <template slot-scope="scope">
                  <el-tag
                    ...
                    :type="levelDirectionList&&levelDirectionList[scope.row.order_book_id]?
                            ...
                            :'info'"
                  >{{ levelDirectionList&&levelDirectionList[scope.row.order_book_id]?levelDirectionList[scope.row.order_book_id]['15m']:'' }}</el-tag>
                </template>
              </el-table-column>
              <el-table-column label="15m">
                <template slot-scope="scope">
                  ...
                  >{{ beichiList[scope.row.order_book_id]['15m'] }}</el-tag>
                </template>
              </el-table-column>
                ...
                <template slot-scope="scope">
                  <el-tag
                    ...
                    :type="levelDirectionList&&levelDirectionList[scope.row.order_book_id]?
                            ...
                            :'info'"
                  >{{ levelDirectionList&&levelDirectionList[scope.row.order_book_id]?levelDirectionList[scope.row.order_book_id]['30m']:'' }}</el-tag>
                </template>
              </el-table-column>
              <el-table-column label="30m">
                <template slot-scope="scope">
                  ...
                  >{{ beichiList[scope.row.order_book_id]['30m'] }}</el-tag>
                </template>
              </el-table-column>
                ...
                <template slot-scope="scope">
                  <el-tag
                    ...
                    :type="levelDirectionList&&levelDirectionList[scope.row.order_book_id]?
                            ...
                            :'info'"
                  >{{ levelDirectionList&&levelDirectionList[scope.row.order_book_id]?levelDirectionList[scope.row.order_book_id]['60m']:'' }}</el-tag>
                </template>
              </el-table-column>
              <el-table-column label="60m">
                <template slot-scope="scope">
                  ...
                  >{{ beichiList[scope.row.order_book_id]['60m'] }}</el-tag>
                </template>
              </el-table-column>
            </el-table>
          </div>
