...
<script>
    ...
    export default {
        ...
        methods: {
            async getStockData() {
                // 恢复缩放比例
                // this.zoomStart = this.myChart.getOption().dataZoom[0].start;
                let requestData = {
                    symbol: this.symbol,
                    period: this.period
                };
                let res = await userApi.stockData(requestData);
                console.log("结果:", res)
