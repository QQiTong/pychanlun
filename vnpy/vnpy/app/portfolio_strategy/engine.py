...
from vnpy.vnpy.trader.utility import load_json, save_json, extract_vt_symbol, round_to
from vnpy.vnpy.trader.database import database_manager
from vnpy.vnpy.trader.rqdata import rqdata_client
from vnpy.vnpy.trader.converter import OffsetConverter
...
class StrategyEngine(BaseEngine):
    ...
    def load_strategy_class(self):
        ...
        self.load_strategy_class_from_folder(path1, "vnpy.vnpy.app.portfolio_strategy.strategies")
